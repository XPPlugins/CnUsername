...
| Fabric及其衍生产品 (包括各类Hybrid核心、客户端)   | 1.18+           | :heavy_check_mark: 作为FabricMod加载; 支持客户端单人游戏                         |
| Forge及其衍生产品 (包括各类Hybrid核心、客户端)    | None            | :x: 理论上不支持，并没有人测试，也没人反馈                                             |
| NeoForge及其衍生产品 (包括各类Hybrid核心、客户端) | 1.21.11; 26.1.2 | :heavy_check_mark: 作为NeoForge Mod加载; 支持客户端单人游戏; 在标定版本测试通过，理论上有跨版本可能 |
